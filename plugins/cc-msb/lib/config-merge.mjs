// Config resolution chains and merge logic for cc-msb.
...
// sandboxImageSpecial: image uses CC_MSB_SANDBOX_IMAGE for main + special agent fallback
const SETTINGS = [
  { key: 'sandbox_image',       type: 'SCALAR',      envMain: 'CC_MSB_SANDBOX_IMAGE',             envAgent: 'CC_MSB_AGENT_IMAGE',              sandboxImageSpecial: true, default: 'ubuntu'   },
  { key: 'scope',               type: 'SCALAR',      envMain: 'CC_MSB_MAIN_SCOPE',                envAgent: 'CC_MSB_AGENT_SCOPE',              default: 'session'  },
  { key: 'sandbox_name',        type: 'SCALAR',      envMain: 'CC_MSB_SANDBOX_NAME',              envAgent: 'CC_MSB_AGENT_SANDBOX_NAME',       sandboxNameSpecial: true,  default: ''         },
  { key: 'mount_workdir',       type: 'SCALAR',      envMain: 'CC_MSB_MAIN_MOUNT_WORKDIR',        envAgent: 'CC_MSB_AGENT_MOUNT_WORKDIR',      noAgentSuffix: true,       default: 'true'     },
  { key: 'pass_env',            type: 'LIST_PASSENV',envMain: 'CC_MSB_MAIN_PASS_ENV',             envAgent: 'CC_MSB_AGENT_PASS_ENV',           default: 'none'     },
  { key: 'network',             type: 'LIST_NETWORK',envMain: 'CC_MSB_MAIN_NETWORK',              envAgent: 'CC_MSB_AGENT_NETWORK',            default: 'enabled'  },
  { key: 'ports',               type: 'LIST_CSV',    envMain: 'CC_MSB_MAIN_PORTS',                envAgent: 'CC_MSB_AGENT_PORTS',              default: ''         },
  { key: 'secrets',             type: 'LIST_CSV',    envMain: 'CC_MSB_MAIN_SECRETS',              envAgent: 'CC_MSB_AGENT_SECRETS',            default: ''         },
  { key: 'on_secret_violation', type: 'SCALAR',      envMain: 'CC_MSB_MAIN_ON_SECRET_VIOLATION',  envAgent: 'CC_MSB_AGENT_ON_SECRET_VIOLATION',default: ''         },
  { key: 'tls_intercept',       type: 'SCALAR',      envMain: 'CC_MSB_MAIN_TLS_INTERCEPT',        envAgent: 'CC_MSB_AGENT_TLS_INTERCEPT',      default: 'false'    },
  { key: 'tls_intercept_port',  type: 'SCALAR',      envMain: 'CC_MSB_MAIN_TLS_INTERCEPT_PORT',   envAgent: 'CC_MSB_AGENT_TLS_INTERCEPT_PORT', default: ''         },
  { key: 'tls_bypass',          type: 'LIST_CSV',    envMain: 'CC_MSB_MAIN_TLS_BYPASS',           envAgent: 'CC_MSB_AGENT_TLS_BYPASS',         default: ''         },
  { key: 'trust_host_cas',      type: 'SCALAR',      envMain: 'CC_MSB_MAIN_TRUST_HOST_CAS',       envAgent: 'CC_MSB_AGENT_TRUST_HOST_CAS',     default: 'false'    },
  { key: 'auto_recreate',       type: 'SCALAR',      envMain: 'CC_MSB_MAIN_AUTO_RECREATE',        envAgent: 'CC_MSB_AGENT_AUTO_RECREATE',      default: 'false'    },
  { key: 'git_user_name',       type: 'SCALAR',      envMain: 'CC_MSB_MAIN_GIT_USER_NAME',        envAgent: 'CC_MSB_AGENT_GIT_USER_NAME',      default: ''         },
  { key: 'git_user_email',      type: 'SCALAR',      envMain: 'CC_MSB_MAIN_GIT_USER_EMAIL',       envAgent: 'CC_MSB_AGENT_GIT_USER_EMAIL',     default: ''         },
  { key: 'github_token',        type: 'SCALAR',      envMain: 'CC_MSB_MAIN_GITHUB_TOKEN',         envAgent: 'CC_MSB_AGENT_GITHUB_TOKEN',       default: ''         },
  { key: 'github_hosts',        type: 'LIST_CSV',    envMain: 'CC_MSB_MAIN_GITHUB_HOSTS',         envAgent: 'CC_MSB_AGENT_GITHUB_HOSTS',       default: ''         },
  { key: 'git_user_autodetect', type: 'SCALAR',      envMain: 'CC_MSB_MAIN_GIT_USER_AUTODETECT',  envAgent: 'CC_MSB_AGENT_GIT_USER_AUTODETECT',default: 'true'     },
  { key: 'git_token_autodetect',type: 'SCALAR',      envMain: 'CC_MSB_MAIN_GIT_TOKEN_AUTODETECT', envAgent: 'CC_MSB_AGENT_GIT_TOKEN_AUTODETECT',default: 'true'    },
];
...
function resolveScalar(s, isMain, agentType, localDoc, globalDoc, presetDocs) {
  ...
  // Special: image agent fallback inserts CC_MSB_SANDBOX_IMAGE between YAML sections
  if (s.sandboxImageSpecial && !isMain) {
    ...
    if (process.env.CC_MSB_SANDBOX_IMAGE) return process.env.CC_MSB_SANDBOX_IMAGE;
  ...
  if (s.sandboxNameSpecial && !isMain) {
    return firstNonEmpty([
      () => get(localDoc,  `agents.${agentType}`, s.key),
      () => get(globalDoc, `agents.${agentType}`, s.key),
    ]) || process.env.CC_MSB_SANDBOX_NAME || '';
  }
