...
if (cfg.scope === 'host') {
  emitContext('cc-msb: main scope is `host` — Bash/Read/Write/Edit run directly on the host, not in a sandbox. The system `# Environment` block above is authoritative.');
  process.exit(0);
}
...
const ctx = `# cc-msb Sandbox Environment (OVERRIDES host \`# Environment\` block)
